...
/*
 * Time:         2018/9/24 23:12
 * Package_Name: com.guikai.cniaoshop.utils
 * File_Name:    Pager
 * Creator:      Anding
 * Note:         封装分页，将不变的部分直接复制过来，改变的部分对外提供参数构建对象，这里采用builder
 */
public class Pager {
    ...
    class RequestCallBack<T> extends SpotsCallBack<Page<T>> {
        ...
        @Override
        public void onSuccess(Call call, Response response, Page<T> tPage) {
